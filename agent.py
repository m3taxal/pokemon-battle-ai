...
class Agent():
    ...
    def run(self, is_training=True, render=False):
        ...
        for episode in itertools.count():
            ...
            # Save model when another 25000 episodes have been processed
            if is_training:
                if episode % 25000 == 0:
                ...
                # Make these lines comments if you do not want to produce graphs for decaying epsilon & mean rewards
